...
<div class="container-fluid px-4 py-4">
    ...
    <div class="pv-page-header">
        <a href="{{ route('presentaciones.index') }}" title="Volver">&#8592;</a>
    ...
    <form action="{{ route('presentaciones.store') }}" method="POST">
        ...
        <div class="pv-card">
            <div class="pv-card-header">
                ...
                <p class="pv-card-header-title">Información de la presentación</p>
            </div>
            <div class="pv-card-body">
                <div class="row g-4">
                    ...
                    <div class="col-md-8">
                        <div class="pv-field @error('nombre') is-invalid @enderror">
                            ...
                            <input type="text" id="nombre" name="nombre"
                                   value="{{ old('nombre') }}" placeholder="Ej: Botella de 1L, Caja de 24...">
                        </div>
                    ...
                    {{-- Sigla --}}
                    <div class="col-md-4">
                        <div class="pv-field @error('sigla') is-invalid @enderror">
                            <label for="sigla">Sigla / Abreviatura *</label>
                            <input type="text" id="sigla" name="sigla"
                                   value="{{ old('sigla') }}" placeholder="Ej: BTL, CJ, KG...">
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="pv-field @error('descripcion') is-invalid @enderror">
                            ...
                            <textarea id="descripcion" name="descripcion" placeholder="Detalles adicionales sobre esta presentación...">{{ old('descripcion') }}</textarea>
                        </div>
        ...
        <div class="pv-form-footer pv-card" style="margin-top:-1px; border-top: none;">
            <a href="{{ route('presentaciones.index') }}" class="btn-pv-cancel">Cancelar</a>
            <button type="submit" class="btn-pv-save">Guardar presentación</button>
        </div>
