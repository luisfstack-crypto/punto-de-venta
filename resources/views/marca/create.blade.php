...
<div class="container-fluid px-4 py-4">
    ...
    <div class="pv-page-header">
        <a href="{{ route('marcas.index') }}" title="Volver">&#8592;</a>
        <h2>Nueva Marca</h2>
    </div>
    ...
    <form action="{{ route('marcas.store') }}" method="POST">
        ...
        <div class="pv-card">
            <div class="pv-card-header">
                ...
                <p class="pv-card-header-title">Información de la marca</p>
            </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-12">
                        <div class="pv-field @error('nombre') is-invalid @enderror">
                            ...
                            <input type="text" id="nombre" name="nombre"
                                   value="{{ old('nombre') }}" placeholder="Ej: Coca-Cola, Sabritas, Nestle...">
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="pv-field @error('descripcion') is-invalid @enderror">
                            ...
                            <textarea id="descripcion" name="descripcion" placeholder="Notas adicionales sobre esta marca...">{{ old('descripcion') }}</textarea>
                        </div>
        ...
        <div class="pv-form-footer pv-card" style="margin-top:-1px; border-top: none;">
            <a href="{{ route('marcas.index') }}" class="btn-pv-cancel">Cancelar</a>
            <button type="submit" class="btn-pv-save">Guardar marca</button>
        </div>
