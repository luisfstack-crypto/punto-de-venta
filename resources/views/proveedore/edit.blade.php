                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nombre_contacto" id="nombre_contacto"
                            class="form-control" value="{{old('nombre_contacto', $proveedore->persona->nombre_contacto)}}"
                    ...
                    <div class="col-12">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="requiere_factura"
                                ...
                                {{ old('requiere_factura', $proveedore->persona->requiere_factura) ? 'checked' : '' }}
                    ...
                    <div class="col-12" id="box-fiscal" style="{{ old('requiere_factura', $proveedore->persona->requiere_factura) ? '' : 'display:none;' }}">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="rfc" id="rfc"
                                            class="form-control" value="{{old('rfc', $proveedore->persona->rfc)}}"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="regimen_fiscal" id="regimen_fiscal"
                                            class="form-control" value="{{old('regimen_fiscal', $proveedore->persona->regimen_fiscal)}}"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="uso_cfdi" id="uso_cfdi"
                                            class="form-control" value="{{old('uso_cfdi', $proveedore->persona->uso_cfdi)}}"
